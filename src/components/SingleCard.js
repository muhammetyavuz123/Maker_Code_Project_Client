                ...
                <div class="content-holder">
                  <div class="content-description">
                    ...
                    <div class="row blog-info">
                      ...
                      <div class="col-xs-12 col-sm-6">
                        <span class="lead text-muted">
                          <i class="fa fa-tags"></i> {this.props.card.mail}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row row-striped">
              ...
              <div class="col-10">
                <h3 class="text-uppercase">
                  <strong>Atatürk Spor Kompleksi</strong>
                </h3>
                <ul class="list-inline">
                  ...
                  <li class="list-inline-item">
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 21.00 PM -
                    22.00 PM
                  </li>
                  <li class="list-inline-item">
                ...
                <p>
                  İşimden Dolayı belirttiğim Saat ve zaman dışında Oynayamıyorum
                  Lütfen Bu zamanlar dışında Rahatsız etmeyin .
                </p>
              </div>
            </div>
            <div class="row row-striped">
              ...
              <div class="col-10">
                ...
                <ul class="list-inline">
                  ...
                  <li class="list-inline-item">
                    <i class="fa fa-clock-o" aria-hidden="true"></i> 23.00 PM -
                    24.00 PM
                  </li>
                  <li class="list-inline-item">
                ...
                <p>
                  Belirttiğim tarilerde buralardayım ancak maerkez halı sahada
                  bu tarihte oynayabilirim
                </p>
              </div>
            </div>
          </div>
